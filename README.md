...
This is a prototype created for the Pirate Software 15 Game Jam, with the themes of Alchemy and Shadows. I am the only person who has directly contributed to this project, but I did use many other people's resources in order to make it possible.
 ...
 Primary Tileset Used (Cave): Cave Tileset, by Sun Dog Games | https://sun-dog-games.itch.io/16x16-rpg-cave 
 
 Font Used: Corset, by somepx | https://somepx.itch.io/pixel-font-corset 
 
 Buttons & Menu Visuals: UI Assets Pack, by Sr. Toasty | https://srtoasty.itch.io/ui-assets-pack-srt 
 
 Dialogue Manager: Dialogue System by Nathan Hoad | https://github.com/nathanhoad/godot_dialogue_manager/tree/main 
